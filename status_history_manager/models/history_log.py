# -*- coding: utf-8 -*-
# Odoo 17 compatible version
# Changes vs Odoo 19 original:
#   - name_get() replaced by _compute_display_name()
#     (name_get deprecated in Odoo 17, removed in Odoo 18)
...
class StatusHistoryLog(models.Model):
    ...
    # Odoo 17+: _compute_display_name() replaces the deprecated name_get().
    # name_get() was deprecated in Odoo 17 and fully removed in Odoo 18.
