...
export class SpotlightSystray extends Component {
    ...
    setup() {
        ...
        // needed on our end.
        //
        // Odoo 17.0 note: this module was originally written against 18/19
        // and ports cleanly - `useHotkey`/`hotkey_hook` and its options
        // (bypassEditableProtection, global) are part of the OWL2 hotkey
        // service that has been stable since the 16.0 rewrite, and 17.0's
        // own built-in Command Palette already depends on it for its
        // Ctrl+K binding. That said, if you're on an early/unusual 17.0
        // build and the hotkey doesn't fire for some reason, the systray
        // icon click (`toggle()` below) always works regardless - it's a
