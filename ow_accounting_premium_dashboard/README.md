...
An Odoo 17 Accounting app dashboard for finance teams. It brings current-period performance, company-currency balances, invoice follow-up, and recent activity into one responsive view.
